...
public class OrangeFragment extends Fragment implements View.OnClickListener {
	 ...
	 */
	static OrangeFragment newInstance() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		Button btnSwitchFragment = rootView.findViewById(R.id.btn_orangeFragmentSwitchFragment);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.btn_orangeFragmentSwitchFragment:
				mListener.changeFragment(GreenFragment.newInstance(), true);
				break;
		}
	}
}
