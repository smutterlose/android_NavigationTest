 ...
 * {@link OnPurpleFragmentInteractionListener} interface
...
public class PurpleFragment extends Fragment {
	...
	private OnPurpleFragmentInteractionListener mListener;
	 ...
	 */
	static PurpleFragment newInstance() {
	...
	public void onAttach(Context context) {
		...
		if (context instanceof OnPurpleFragmentInteractionListener) {
			mListener = (OnPurpleFragmentInteractionListener) context;
		} else {
	 ...
	 */
	public interface OnPurpleFragmentInteractionListener {
